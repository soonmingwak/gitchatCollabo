...
<div class="calendar" >
	...
	<div class="navigation">
		<a class="before_after_year" href="./calendar2?year=${today_info.search_year-1}&month=${today_info.search_month-1}">
			&lt;&lt;
		<!-- 이전해 -->
		</a> 
		<a class="before_after_month" href="./calendar2?year=${today_info.before_year}&month=${today_info.before_month}">
			&lt;
		<!-- 이전달 -->
		</a> 
		...
		<a class="before_after_month" href="/calendar2?year=${today_info.after_year}&month=${today_info.after_month}">
		<!-- 다음달 -->
			&gt;
		</a> 
		<a class="before_after_year" href="/calendar2?year=${today_info.search_year+1}&month=${today_info.search_month-1}">
